...
class hsl_classification:
    ...
    def learn_classification(self, training_samples_path, save_model_path=None, load_model_path=None, max_training_epoch=10):
        ...
        raw_class = np.array(samples['anm_type'].values, dtype=np.int64)
        # Encode raw class to soft target: 0 - [1/3, 1/3, 1/3], 1 - [1, 0, 0], 2 - [0, 1, 0], 3 - [0, 0, 1]
        samples_target = np.zeros((len(raw_class), 3), dtype=np.float32)
