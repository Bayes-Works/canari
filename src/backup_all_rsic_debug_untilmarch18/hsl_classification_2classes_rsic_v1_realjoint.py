        ...
        while i < len(data["x"]):
            ...
            if p_a_I_Yt > self.detection_threshold and rerun_kf is False:
                ...
                if len(data_likelihoods_ll) > 0 and len(data_likelihoods_lt) > 0:
                    ...
                    joint_data_hs_ll_post_n = np.array(data_likelihoods_ll) * np.array(hs_likelihoods_ll) / (np.array(data_likelihoods_ll) * np.array(hs_likelihoods_ll) + np.array(data_likelihoods_lt) * np.array(hs_likelihoods_lt))
                    joint_data_hs_lt_post_n = np.array(data_likelihoods_lt) * np.array(hs_likelihoods_lt) / (np.array(data_likelihoods_ll) * np.array(hs_likelihoods_ll) + np.array(data_likelihoods_lt) * np.array(hs_likelihoods_lt))
                ...
                itv_decision = model_select_beta_credible(alpha=joint_data_hs_ll_post_sum, beta_=joint_data_hs_lt_post_sum)
