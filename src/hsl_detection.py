...
class hsl_detection:
    ...
    def estimate_LTd_dist(self, add_roll_out_ts: Optional[bool] = True):
        ...
        if add_roll_out_ts:
            ...
            generated_ts, time_covariate, _, _ = self.base_model.generate(num_time_series=10, num_time_steps=52*10, 
            ...
            print('mean and std after roll out synthetic data',np.mean(self.LTd_buffer), np.std(self.LTd_buffer))
