...
model = Model(
    ...
    LocalTrend(var_states=[1e-3, 1e-3]),
    # LocalTrend(),
    # ExpSmoothing(mu_states=[0,0.3,0], var_states=[0,1e-2,0], es_order=1, activation=None),
    ExpSmoothing(mu_states=[0,.3,0, 0, 1e-3,0], var_states=[0, 1e-2,0, 0, 1e-7,0], es_order=2, activation="softplus"),
    # ExpSmoothing(mu_states=[0,-3,0, 0,1,0], var_states=[0,0.2,0, 0,1e-1,0], es_order=2, activation="sigmoid"),
    LstmNetwork(
        look_back_len=12*2,
        num_features=2,
        infer_len=12 * 3,
