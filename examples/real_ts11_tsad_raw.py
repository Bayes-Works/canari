...
# with open("saved_params/real_ts11_tsmodel_raw_overtrained.pkl", "rb") as f:
...
hsl_tsad_agent.mu_LTd = 4.9203888666533356e-05 
hsl_tsad_agent.LTd_std = 0.0001390119393945344
# hsl_tsad_agent.mu_LTd = -1.920110982973094e-06 
# hsl_tsad_agent.LTd_std = 8.98492204039113e-05
hsl_tsad_agent.LTd_pdf = common.gaussian_pdf(mu = hsl_tsad_agent.mu_LTd, std = hsl_tsad_agent.LTd_std * 1)

# hsl_tsad_agent.collect_synthetic_samples(num_time_series=1000, save_to_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts11_detrended_raw2.csv')
