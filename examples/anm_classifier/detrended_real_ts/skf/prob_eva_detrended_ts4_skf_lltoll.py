...
# # # Read test data
df = pd.read_csv("data/prob_eva_syn_time_series/detrend_rsic_simple_ts4_gen_lltoll.csv")
...
results_df.to_csv("saved_results/prob_eva/detrend_ts4_results_skf_lltoll.csv", index=False)