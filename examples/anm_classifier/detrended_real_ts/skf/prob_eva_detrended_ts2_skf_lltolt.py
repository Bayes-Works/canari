...
# # # Read test data
df = pd.read_csv("data/prob_eva_syn_time_series/detrend_rsic_simple_ts2_gen_lltolt.csv")
...
results_df.to_csv("saved_results/prob_eva/detrend_ts2_results_skf_lltolt.csv", index=False)