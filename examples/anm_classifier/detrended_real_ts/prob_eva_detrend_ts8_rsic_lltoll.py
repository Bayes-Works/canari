...
df = pd.read_csv("data/prob_eva_syn_time_series/detrend_rsic_simple_ts8_gen_lltoll.csv")
...
hsl_tsad_agent.mu_LTd =  -2.7861507872827957e-05
hsl_tsad_agent.LTd_std = 5.3953390918977734e-05
...
hsl_tsad_agent.mean_LTd_class, hsl_tsad_agent.std_LTd_class = -4.352798e-05, 0.0009081676
hsl_tsad_agent.mean_target_lt_model, hsl_tsad_agent.std_target_lt_model = np.array([0.00026477, 0.02731053]), np.array([0.00650668, 0.86058235])
hsl_tsad_agent.mean_target_ll_model, hsl_tsad_agent.std_target_ll_model = np.array([-0.02324484]), np.array([0.6775377])

hsl_tsad_agent.learn_intervention(training_samples_path='data/anm_type_class_train_samples/classifier_learn_samples_detrended_ts8.csv', 
                                    load_lt_model_path='saved_params/NN_intervention_LT_model_rsic_detrend_ts8.pkl', 
                                    load_ll_model_path='saved_params/NN_intervention_LL_model_rsic_detrend_ts8.pkl', 
...
results_df.to_csv("saved_results/prob_eva/detrend_ts8_results_rsic_lltoll.csv", index=False)