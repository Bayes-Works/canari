...
hsl_tsad_agent.mean_LTd_class, hsl_tsad_agent.std_LTd_class = -7.276305e-05, 0.00097622006
hsl_tsad_agent.mean_target_lt_model, hsl_tsad_agent.std_target_lt_model = np.array([-0.00030188, -0.03621958]), np.array([0.00651432, 0.857714])
hsl_tsad_agent.mean_target_ll_model, hsl_tsad_agent.std_target_ll_model = np.array([-0.02724162]), np.array([0.6384397])

hsl_tsad_agent.learn_intervention(training_samples_path='data/anm_type_class_train_samples/classifier_learn_samples_detrended_ts1.csv', 
                                    load_lt_model_path='saved_params/NN_intervention_LT_model_rsic_detrend_ts1.pkl', 
                                    load_ll_model_path='saved_params/NN_intervention_LL_model_rsic_detrend_ts1.pkl', 
...
results_df.to_csv("saved_results/prob_eva/detrend_ts1_results_rsic_lltolt.csv", index=False)