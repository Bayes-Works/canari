...
hsl_tsad_agent.mean_LTd_class, hsl_tsad_agent.std_LTd_class = -2.4148112e-05, 0.0008765512
hsl_tsad_agent.mean_target_lt_model, hsl_tsad_agent.std_target_lt_model = np.array([-0.00028879, -0.03220706]), np.array([0.00673162, 0.8963367])
hsl_tsad_agent.mean_target_ll_model, hsl_tsad_agent.std_target_ll_model = np.array([1.0815178e-05]), np.array([0.67492884])

hsl_tsad_agent.learn_intervention(training_samples_path='data/anm_type_class_train_samples/classifier_learn_samples_detrended_ts2.csv', 
                                    load_lt_model_path='saved_params/NN_intervention_LT_model_rsic_detrend_ts2.pkl', 
                                    load_ll_model_path='saved_params/NN_intervention_LL_model_rsic_detrend_ts2.pkl', 
...
results_df.to_csv("saved_results/prob_eva/detrend_ts2_results_rsic_lltolt.csv", index=False)