...
df = pd.read_csv("data/prob_eva_syn_time_series/detrend_rsic_simple_ts5_gen_lttolt.csv")
...
hsl_tsad_agent.mu_LTd = 1.2628795957014409e-05
hsl_tsad_agent.LTd_std = 7.094515331490936e-05 * 1.3
...
hsl_tsad_agent.mean_LTd_class, hsl_tsad_agent.std_LTd_class = -3.5005192e-05, 0.0015438698
hsl_tsad_agent.mean_target_lt_model, hsl_tsad_agent.std_target_lt_model = np.array([-0.00010386, -0.00977434]), np.array([0.00653665, 0.8635393])
hsl_tsad_agent.mean_target_ll_model, hsl_tsad_agent.std_target_ll_model = np.array([-0.01107259]), np.array([0.67867506])

hsl_tsad_agent.learn_intervention(training_samples_path='data/anm_type_class_train_samples/classifier_learn_samples_detrended_ts5.csv', 
                                    load_lt_model_path='saved_params/NN_intervention_LT_model_rsic_detrend_ts5.pkl', 
                                    load_ll_model_path='saved_params/NN_intervention_LL_model_rsic_detrend_ts5.pkl', 
...
results_df.to_csv("saved_results/prob_eva/detrend_ts5_results_rsic_lttolt.csv", index=False)