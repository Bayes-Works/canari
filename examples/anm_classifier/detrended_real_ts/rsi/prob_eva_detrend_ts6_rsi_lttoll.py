...
hsl_tsad_agent.mean_train, hsl_tsad_agent.std_train, hsl_tsad_agent.mean_target, hsl_tsad_agent.std_target = 0.000114449824, 0.0020520121, np.array([3.2423629e-04, 5.2314021e-02, 1.1223563e+02]), np.array([1.0987490e-02, 1.4340402e+00, 6.8464691e+01])
hsl_tsad_agent.learn_intervention(training_samples_path='data/hsl_tsad_training_samples/rsi_learn_samples_detrended_ts6.csv', 
                                  load_model_path='saved_params/NN_intervention_model_detrended_ts6_rsi.pkl', max_training_epoch=50)
...
results_df.to_csv("saved_results/prob_eva/detrend_ts6_results_rsi_lttoll.csv", index=False)