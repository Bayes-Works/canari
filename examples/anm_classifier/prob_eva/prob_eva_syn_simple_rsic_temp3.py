...
df = pd.read_csv("data/prob_eva_syn_time_series/syn_rsic_simple_ts_gen_lttolt_feb.csv")
...
results_df.to_csv("saved_results/prob_eva/syn_simple_ts_results_rsic_lttolt_debug2_1_bnnitv.csv", index=False)