...
from src.hsl_classification_2classes_rsic_v1_sigmall import hsl_classification
...
results_df.to_csv("saved_results/prob_eva/syn_simple_ts_results_rsic_v1_sigmall_lttoll.csv", index=False)