...
with open("saved_params/real_ts2_tsmodel_raw.pkl", "rb") as f:
...
hsl_tsad_agent.mu_LTd = 1.081675065360854e-06
hsl_tsad_agent.LTd_std = 8.266147124248587e-05
...
# hsl_tsad_agent.collect_anmtype_samples(num_time_series=1000, save_to_path='data/anm_type_class_train_samples/classifier_learn_samples_real_ts2.csv')

hsl_tsad_agent.mean_LTd_class, hsl_tsad_agent.std_LTd_class,hsl_tsad_agent.mean_LTd2_class, hsl_tsad_agent.std_LTd2_class = -2.7966342e-05, 0.0007453049, -0.00017813701, 0.0057325773
hsl_tsad_agent.mean_target_lt_model, hsl_tsad_agent.std_target_lt_model = np.array([-0.00027189, -0.03040082]), np.array([0.00648758, 0.8488831])
hsl_tsad_agent.mean_target_ll_model, hsl_tsad_agent.std_target_ll_model = np.array([0.01750277]), np.array([0.66718084])
...
hsl_tsad_agent.learn_intervention(training_samples_path='data/anm_type_class_train_samples/classifier_learn_samples_real_ts2.csv', 
                                    load_lt_model_path='saved_params/NN_intervention_LT_model_real_ts2.pkl', 
                                    load_ll_model_path='saved_params/NN_intervention_LL_model_real_ts2.pkl', 
