...
with open("saved_params/real_ts6_tsmodel_raw.pkl", "rb") as f:
...
hsl_tsad_agent.mu_LTd =  1.8797465519437793e-06
hsl_tsad_agent.LTd_std = 9.397382027314409e-05
...
# hsl_tsad_agent.collect_anmtype_samples(num_time_series=1000, save_to_path='data/anm_type_class_train_samples/classifier_learn_samples_real_ts6.csv')

hsl_tsad_agent.mean_LTd_class, hsl_tsad_agent.std_LTd_class,hsl_tsad_agent.mean_LTd2_class, hsl_tsad_agent.std_LTd2_class = -8.48405e-05, 0.00072611147, -0.00029423184, 0.008895418
hsl_tsad_agent.mean_target_lt_model, hsl_tsad_agent.std_target_lt_model = np.array([-0.00027263, -0.03280745]), np.array([0.00636084, 0.8371149])
hsl_tsad_agent.mean_target_ll_model, hsl_tsad_agent.std_target_ll_model = np.array([0.04974715]), np.array([0.6813843])
...
hsl_tsad_agent.learn_intervention(training_samples_path='data/anm_type_class_train_samples/classifier_learn_samples_real_ts6.csv', 
                                    load_lt_model_path='saved_params/NN_intervention_LT_model_real_ts6.pkl', 
                                    load_ll_model_path='saved_params/NN_intervention_LL_model_real_ts6.pkl', 
