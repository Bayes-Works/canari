...
hsl_tsad_agent.detection_threshold = 0.31005283829096303

# hsl_tsad_agent.collect_anmtype_samples(num_time_series=1000, save_to_path='data/anm_type_class_train_samples/classifier_learn_samples_real_ts9.csv')

hsl_tsad_agent.mean_LTd_class, hsl_tsad_agent.std_LTd_class = 2.3850342e-05, 0.00015935955
hsl_tsad_agent.mean_target_lt_model, hsl_tsad_agent.std_target_lt_model = np.array([-5.3566906e-05, -5.6211865e-03]), np.array([0.00620752, 0.8287443])
hsl_tsad_agent.mean_target_ll_model, hsl_tsad_agent.std_target_ll_model = np.array([-0.00312395]), np.array([0.6485277])
...
hsl_tsad_agent.learn_intervention(training_samples_path='data/anm_type_class_train_samples/classifier_learn_samples_real_ts9.csv', 
                                    load_lt_model_path='saved_params/NN_intervention_LT_model_rsicv1_real_ts9.pkl', 
                                    load_ll_model_path='saved_params/NN_intervention_LL_model_rsicv1_real_ts9.pkl', 
