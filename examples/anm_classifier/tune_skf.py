...
# SKF_std_transition_error_fix = 0.0009524684657618379
# SKF_norm_to_abnorm_prob_fix = 0.0002860998707891596
# threshold_anm_prob_fix = 0.5036491610705127

SKF_std_transition_error_fix = 7.875379715217655e-05
SKF_norm_to_abnorm_prob_fix = 1.9958538040725365e-06
threshold_anm_prob_fix = 0.4256530410044609
...
def main(
    ...
    time_anomaly2 = 52*10
    anm_mag2 = 18/52
    anm_baseline2 = np.arange(len(df_raw)) * anm_mag2
    # Set the first 52*12 values in anm_baseline to be 0
    anm_baseline2[time_anomaly2:] -= anm_baseline2[time_anomaly2]
    anm_baseline2[:time_anomaly2] = 0
    df_raw = df_raw.add(anm_baseline2, axis=0)
    ...
    if param_optimization:
        ...
        skf_param = {
            ...
            "threshold_anm_prob": threshold_anm_prob_fix,
        }
