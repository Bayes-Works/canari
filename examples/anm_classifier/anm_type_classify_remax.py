...
from src.hsl_classification_mp2_3classes_tagiv_continuous import hsl_classification
...
# hsl_tsad_agent.collect_anmtype_samples(num_time_series=1000, save_to_path='data/anm_type_class_train_samples/classifier_learn_samples_syn_simple_ts_mp2_continuous.csv')
...
# Continuous space moments
hsl_tsad_agent.mean_LTd_class, hsl_tsad_agent.std_LTd_class, hsl_tsad_agent.mean_MP_class, hsl_tsad_agent.std_MP_class =  3.4790737e-06, 0.00033807708, 3.7814422, 2.0699499
hsl_tsad_agent.learn_classification(training_samples_path='data/anm_type_class_train_samples/classifier_learn_samples_syn_simple_ts_mp2_continuous.csv', 
                                    load_model_path='saved_params/NN_classification_model_syn_simple_ts_mp2_3classes_tagi_learnlogit_continuous.pkl', max_training_epoch=50)
...
## ReMax(logits)
from src.convert_to_class import log_remax
m_probs, std_probs = [], []
for t in range(m_logits.shape[0]):
    m_prob, s_prob = log_remax(m_logits[t], std_logits[t])
    m_probs.append(m_prob.tolist())
    std_probs.append(s_prob.tolist())
...
ax10.legend(['LT', 'LL', 'PD'],loc='upper left', ncol=2)
