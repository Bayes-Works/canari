...
# MP2 models:
# hsl_tsad_agent.mean_LTd_class, hsl_tsad_agent.std_LTd_class, hsl_tsad_agent.mean_MP_class, hsl_tsad_agent.std_MP_class = -0.00010018448, 0.00039827698, 4.021743, 1.4004476
hsl_tsad_agent.learn_classification(training_samples_path='data/anm_type_class_train_samples/classifier_learn_samples_syn_simple_ts_two_classes.csv', 
                                    save_model_path='saved_params/NN_classification_model_syn_simple_ts_mp2_2classes_tagi_hiersm.pkl', max_training_epoch=50)
