...
hsl_tsad_agent.mean_train, hsl_tsad_agent.std_train, hsl_tsad_agent.mean_target, hsl_tsad_agent.std_target = 1.1442081e-05, 0.0009285458, np.array([2.9006900e-04, 3.3594806e-02, 1.0727357e+02]), np.array([1.1086351e-02, 1.3780332e+00, 6.2554661e+01])
...
hsl_tsad_agent.learn_intervention(training_samples_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts11_detrended.csv', 
                                  save_model_path='saved_params/NN_detection_model_real_ts11_detrended.pkl', max_training_epoch=50)
