...
#                                      [0.00016600693489812662, 3.6336447809749773e-06, 0.1965699262629972],
#                                      [0.00020469992939849328, 0.0005471217507074679, 0.018683725269818742],
#                                      [0.0003960381856160914, 9.003843499239182e-06, 0.13864600073235683],
#                                      [0.00029169621813497897, 1.048657378288797e-05, 0.28959472875371634],
#                                      [0.00012091220026969719, 3.836003811409869e-06, 0.031458635032830994],
#                                      [0.0002030904196726535, 0.00014838603725652447, 0.12844583525701508],
#                                      [0.0002401709570873947, 7.104585539639224e-06, 0.05046454517985501],
#                                      [4.849910470304192e-05, 0.0007948424634600788, 0.04046489015450754],
#                                      [0.00019083131748051776, 3.980266287679024e-06, 0.020113559169500292],
#                                      [0.00043174066842593473, 4.535458698999653e-05, 0.012999423513012975],
#                                      ]

stdtrans_normtoab_probthred_combs = [
                                     [4.9888433727612196e-05, 7.464206266630617e-06, 0.14068345955160436],
                                     [8.28308175607253e-05, 4.046480619623276e-05, 0.026691383745222612],
                                     [5.1663437528237446e-05, 0.00019389217059220243, 0.04196479157383191],
                                     [6.053963090804431e-05, 4.134594709414345e-06, 0.5821833975493076],
                                     [5.734613979218388e-05, 0.0007676037088447748, 0.01885636103445161],
                                     [5.8786974225661876e-05, 7.450535657152539e-06, 0.1276412354922711],
                                     [6.698777208241081e-05, 5.666348356181805e-05, 0.016144412057320482],
                                     [8.952425226305276e-05, 0.0001017609301203491, 0.10062154923257331],
                                     [6.642633111100263e-05, 8.574313669083717e-05, 0.20388343286069363],
                                     ]
...
# # # Read test data
df = pd.read_csv("data/prob_eva_syn_time_series/detrended_ts6_tsgen.csv")
...
results_df.to_csv("saved_results/prob_eva/detrended_ts6_results_skf_aug14.csv", index=False)