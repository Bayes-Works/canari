...
hsl_tsad_agent.mu_LTd = -2.2528237585734332e-05
hsl_tsad_agent.LTd_std = 8.923578426166267e-05
hsl_tsad_agent.LTd_pdf = common.gaussian_pdf(mu = hsl_tsad_agent.mu_LTd, std = hsl_tsad_agent.LTd_std * 2.9)
hsl_tsad_agent.tune_panm_threshold(data=normalized_data)

hsl_tsad_agent.nn_train_with = 'tagiv'
hsl_tsad_agent.mean_train, hsl_tsad_agent.std_train, hsl_tsad_agent.mean_target, hsl_tsad_agent.std_target = 5.038056e-05, 0.0012851112, np.array([8.0242386e-04, 8.5863568e-02, 1.0731073e+02]), np.array([1.0943341e-02, 1.3590854e+00, 6.2556824e+01])
hsl_tsad_agent.learn_intervention(training_samples_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts1_detrended.csv', 
                                  load_model_path='saved_params/NN_detection_model_real_ts1_detrended.pkl', max_training_epoch=50)
...
#     k += 150
    ...
    data_processor_k.scale_const_mean = copy.deepcopy(data_processor.scale_const_mean)
    data_processor_k.scale_const_std = copy.deepcopy(data_processor.scale_const_std)
...
results_df.to_csv("saved_results/prob_eva/detrended_ts1_results_il.csv", index=False)