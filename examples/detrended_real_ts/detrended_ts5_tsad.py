...
hsl_tsad_agent.LTd_std = 7.094515331490936e-05
hsl_tsad_agent.LTd_pdf = common.gaussian_pdf(mu = hsl_tsad_agent.mu_LTd, std = hsl_tsad_agent.LTd_std * 1.3)
hsl_tsad_agent.tune_panm_threshold(data=normalized_data)

# hsl_tsad_agent.collect_synthetic_samples(num_time_series=1000, save_to_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts5_detrended.csv')
hsl_tsad_agent.nn_train_with = 'tagiv'
hsl_tsad_agent.mean_train, hsl_tsad_agent.std_train, hsl_tsad_agent.mean_target, hsl_tsad_agent.std_target = -5.351203e-05, 0.0020717396, np.array([-2.3693594e-04, -2.7261395e-02, 1.0735143e+02]), np.array([1.1295601e-02, 1.4015310e+00, 6.2493263e+01])
