...
hsl_tsad_agent.LTd_pdf = common.gaussian_pdf(mu = hsl_tsad_agent.mu_LTd, std = hsl_tsad_agent.LTd_std * 2.8)
...
hsl_tsad_agent.learn_intervention(training_samples_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts1_detrended.csv', 
                                  save_model_path='saved_params/NN_detection_model_real_ts1_detrended.pkl', max_training_epoch=50)
