...
hsl_tsad_agent.LTd_std = 7.357137631104162e-05
hsl_tsad_agent.LTd_pdf = common.gaussian_pdf(mu = hsl_tsad_agent.mu_LTd, std = hsl_tsad_agent.LTd_std * 1.6)
hsl_tsad_agent.tune_panm_threshold(data=normalized_data)

hsl_tsad_agent.nn_train_with = 'tagiv'
hsl_tsad_agent.mean_train, hsl_tsad_agent.std_train, hsl_tsad_agent.mean_target, hsl_tsad_agent.std_target = -1.134879e-05, 0.0011665067, np.array([-1.9414320e-04, -2.3430184e-02, 1.0732422e+02]), np.array([1.10866735e-02, 1.37618959e+00, 6.25898552e+01])
