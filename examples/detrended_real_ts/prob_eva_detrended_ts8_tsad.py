...
hsl_tsad_agent.mean_train, hsl_tsad_agent.std_train, hsl_tsad_agent.mean_target, hsl_tsad_agent.std_target = -5.9492668e-05, 0.0011656747, np.array([3.08761373e-04, 3.22868302e-02, 1.07113625e+02]), np.array([1.1115842e-02, 1.3778932e+00, 6.2426071e+01])
...
results_df.to_csv("saved_results/prob_eva/detrended_ts8_results_il.csv", index=False)