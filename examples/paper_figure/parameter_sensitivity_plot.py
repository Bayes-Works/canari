...
ax[0].plot(df_il_mean.index, df_il_mean["detection_time"]["mean"], label=r"\textbf{NN1}")
ax[0].fill_between(
    df_il_mean.index,
...
ax[0].plot(df_il2_mean.index, df_il2_mean["detection_time"]["mean"], label="NN2") # 1 * 32
ax[0].fill_between(
    df_il2_mean.index,
...
ax[0].plot(df_il3_mean.index, df_il3_mean["detection_time"]["mean"], label="NN3") # 2 * 256
ax[0].fill_between(
    df_il3_mean.index,
