...
ax[0].plot(df_skf_whitenoise_mean.index, df_skf_whitenoise_mean["detection_time"]["mean"], label="Matrix Profile", linewidth=1, color='tab:red')
ax[0].fill_between(
...
ax[0].plot(df_prophet_mean.index, df_prophet_mean["detection_time"]["mean"], label="Prophet", linewidth=1, color='tab:purple')
ax[0].fill_between(
...
ax[0].plot(df_lstmed_mean.index, df_lstmed_mean["detection_time"]["mean"], label="LSTMED", linewidth=1, color='tab:brown')
ax[0].fill_between(
...
ax[0].plot(df_catch_mean.index, df_catch_mean["detection_time"]["mean"], label="TranAD", linewidth=1, color='tab:pink')
ax[0].fill_between(
    df_catch_mean.index,
...
ax[1].plot(df_skf_whitenoise_mean.index, df_skf_whitenoise_mean["detection_rate"]["mean"], label="Matrix profile", linewidth=1, color='tab:red')
ax[1].plot(df_prophet_mean.index, df_prophet_mean["detection_rate"]["mean"], label="Prophet", linewidth=1, color='tab:purple')
ax[1].plot(df_lstmed_mean.index, df_lstmed_mean["detection_rate"]["mean"], label="LSTMED", linewidth=1, color='tab:brown')
...
ax[2].plot(df_catch_mean.index, df_catch_mean["alarms_num"]["mean"], label="Catch", color = "tab:pink")
ax[2].fill_between(
    df_catch_mean.index,
