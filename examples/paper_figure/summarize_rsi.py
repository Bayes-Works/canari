...
# # # Read data
data_file = "./data/toy_time_series/paper_data_decompose_delay_example_long.csv"
...
add_intervention_proportion = 0.4
test_data_part1 = {
...
plt.savefig('ssm_base_drift_example.png', dpi=300)
plt.show()