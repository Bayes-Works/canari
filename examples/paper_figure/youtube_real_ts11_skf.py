...
def main(
    ...
    if param_optimization:
        ...
        skf_param = {
            "std_transition_error": 5.296465438130529e-05,
            "norm_to_abnorm_prob": 1.0747253016614227e-06,
            "slope": 0.008071532245755105,
            "threshold_anm_prob": 0.45729996249957877,
        }
    ...
    # Save the results, including level, trend, and autoregression, and filter_marginal_abnorm_prob to a CSV file
    results_df = pd.DataFrame({
        ...
        "ar_mean": ar_mean,
        "ar_std": ar_std,
        "abnormal_prob": filter_marginal_abnorm_prob,
    })
