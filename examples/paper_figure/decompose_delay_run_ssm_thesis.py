...
mu_y_preds, std_y_preds, states = pretrained_model.filter(normalized_data,train_lstm=False)
...
level_mean = states.get_mean(states_type=states_type, states_name="level",
...
level_std = states.get_std(states_type=states_type, states_name="level",
            standardization=False,scale_const_std=data_processor.scale_const_std[data_processor.output_col],)
trend_mean = states.get_mean(states_type=states_type, states_name="trend",
            standardization=False,scale_const_mean=data_processor.scale_const_mean[data_processor.output_col],scale_const_std=data_processor.scale_const_std[data_processor.output_col],)
trend_std = states.get_std(states_type=states_type, states_name="trend",
            standardization=False,scale_const_std=data_processor.scale_const_std[data_processor.output_col],)
ar_mean = states.get_mean(states_type=states_type, states_name="autoregression",
            standardization=False,scale_const_mean=data_processor.scale_const_mean[data_processor.output_col],scale_const_std=data_processor.scale_const_std[data_processor.output_col],)
ar_std = states.get_std(states_type=states_type, states_name="autoregression",
            standardization=False,scale_const_std=data_processor.scale_const_std[data_processor.output_col],)
lstm_mean = states.get_mean(states_type=states_type, states_name="lstm",
            standardization=False,scale_const_mean=data_processor.scale_const_mean[data_processor.output_col],scale_const_std=data_processor.scale_const_std[data_processor.output_col],)
lstm_std = states.get_std(states_type=states_type, states_name="lstm",
            standardization=False,scale_const_std=data_processor.scale_const_std[data_processor.output_col],)
...
# ax0: plot data
ax0.plot(time, df_raw["obs"].iloc[:len(time)], 'k')
...
ax2.plot(time, lstm_mean, color="tab:blue")
ax2.fill_between(time, lstm_mean - lstm_std, lstm_mean + lstm_std, color="tab:blue", alpha=0.2)
ax2.set_ylabel(r"$x^{\mathtt{LSTM}}$")
ax2.set_xticklabels([])
...
ax3.plot(time, ar_mean, color="tab:blue")
ax3.fill_between(time, ar_mean - ar_std, ar_mean + ar_std, color="tab:blue", alpha=0.2)
# ax2.set_xticklabels([])
ax3.set_ylabel(r"$x^{\mathtt{AR}}$")
