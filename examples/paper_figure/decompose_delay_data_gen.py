...
model = Model(
    ...
    Autoregression(
        std_error=5, phi=0.75, mu_states=[-0.0621], var_states=[6.36e-05]
    ),
)
num_time_steps = 52 * 8
...
start_time = pd.Timestamp('2017-02-06 00:00:00')
...
df.to_csv('data/toy_time_series/paper_data_decompose_delay_example.csv', index=False)
