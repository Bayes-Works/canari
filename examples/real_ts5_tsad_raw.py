...
hsl_tsad_agent.mu_LTd = 9.159752119656003e-06
hsl_tsad_agent.LTd_std = 5.530436695253462e-05
hsl_tsad_agent.LTd_pdf = common.gaussian_pdf(mu = hsl_tsad_agent.mu_LTd, std = hsl_tsad_agent.LTd_std * 1)

# hsl_tsad_agent.collect_synthetic_samples(num_time_series=1000, save_to_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts5_detrended_raw.csv')
hsl_tsad_agent.nn_train_with = 'tagiv'
hsl_tsad_agent.mean_train, hsl_tsad_agent.std_train, hsl_tsad_agent.mean_target, hsl_tsad_agent.std_target = 7.354466e-05, 0.0012190012, np.array([7.4456056e-04, 8.6904347e-02, 1.0537194e+02]), np.array([1.1124148e-02, 1.3523600e+00, 6.2222351e+01])
# hsl_tsad_agent.tune()
# hsl_tsad_agent.LTd_pdf = common.gaussian_pdf(mu = hsl_tsad_agent.mu_LTd, std = hsl_tsad_agent.LTd_std * 0.7290000000000001)
hsl_tsad_agent.learn_intervention(training_samples_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts5_detrended_raw.csv', 
                                  load_model_path='saved_params/NN_detection_model_real_ts5_detrended_raw.pkl', max_training_epoch=50)
