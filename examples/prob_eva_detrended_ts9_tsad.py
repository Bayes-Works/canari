...
import copy
from canari.component import LocalTrend, LstmNetwork, Periodic, Autoregression, WhiteNoise
from canari import (
    DataProcess,
    Model,
    common,
...
results_df.to_csv("saved_results/prob_eva/detrended_ts9_wn_results_il.csv", index=False)