...
with open("saved_params/real_ts9_lstmres.pkl", "rb") as f:
...
hsl_tsad_agent = hsl_detection(base_model=base_model, generate_model=gen_model, data_processor=data_processor, drift_model_process_error_std=ltd_error, y_std_scale = 1)
