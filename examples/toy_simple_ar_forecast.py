...
from canari.component import LocalTrend, LstmNetwork, WhiteNoise, Autoregression
...
for epoch in range(num_epoch):
    ...
    # Early-stopping
    model.early_stopping(evaluate_metric=mse, current_epoch=epoch, max_epoch=num_epoch,skip_epoch=50)
