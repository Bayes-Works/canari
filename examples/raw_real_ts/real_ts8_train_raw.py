...
var_W2bar_prior = 1e2
AR = Autoregression(mu_states=[0, 0, 0, 0, 0, AR_process_error_var_prior],var_states=[0.01, 0.01, 0, AR_process_error_var_prior, 0, var_W2bar_prior])
LSTM = LstmNetwork(
        look_back_len=22,
        num_features=2,
        num_layer=1,
...
import pickle
with open("saved_params/real_ts8_tsmodel_raw.pkl", "wb") as f:
