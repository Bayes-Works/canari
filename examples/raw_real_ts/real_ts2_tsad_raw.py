...
# hsl_tsad_agent.collect_synthetic_samples(num_time_series=1000, save_to_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts2_raw.csv')
hsl_tsad_agent.nn_train_with = 'tagiv'
hsl_tsad_agent.mean_train, hsl_tsad_agent.std_train, hsl_tsad_agent.mean_target, hsl_tsad_agent.std_target = -2.2268965e-05, 0.0010118212, np.array([1.5294968e-04, 1.8203786e-02, 1.0745670e+02]), np.array([1.1201279e-02, 1.3960019e+00, 6.2648106e+01])

hsl_tsad_agent.learn_intervention(training_samples_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts2_raw.csv', 
                                  load_model_path='saved_params/NN_detection_model_real_ts2_raw.pkl', max_training_epoch=50)
