...
hsl_tsad_agent.mu_LTd =  -1.2191124551665467e-05
hsl_tsad_agent.LTd_std = 5.967314498955507e-05
...
# hsl_tsad_agent.collect_synthetic_samples(num_time_series=1000, save_to_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts8_raw.csv')
hsl_tsad_agent.nn_train_with = 'tagiv'
hsl_tsad_agent.mean_train, hsl_tsad_agent.std_train, hsl_tsad_agent.mean_target, hsl_tsad_agent.std_target = -7.171509e-05, 0.0005724509, np.array([4.2836936e-04, 4.7787931e-02, 1.0647112e+02]), np.array([1.0945284e-02, 1.3518273e+00, 6.2646320e+01])

hsl_tsad_agent.learn_intervention(training_samples_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts8_raw.csv', 
                                  load_model_path='saved_params/NN_detection_model_real_ts8_raw.pkl', max_training_epoch=50)
