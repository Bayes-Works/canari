...
# hsl_tsad_agent.collect_synthetic_samples(num_time_series=1000, save_to_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts10_raw.csv')
hsl_tsad_agent.nn_train_with = 'tagiv'
hsl_tsad_agent.mean_train, hsl_tsad_agent.std_train, hsl_tsad_agent.mean_target, hsl_tsad_agent.std_target = -9.589545e-06, 0.000651873, np.array([3.0832551e-04, 3.4310579e-02, 1.0744681e+02]), np.array([1.1254373e-02, 1.4035622e+00, 6.2645565e+01])

hsl_tsad_agent.learn_intervention(training_samples_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts10_raw.csv', 
                                  load_model_path='saved_params/NN_detection_model_real_ts10_raw.pkl', max_training_epoch=50)
