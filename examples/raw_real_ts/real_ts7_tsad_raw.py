...
# hsl_tsad_agent.collect_synthetic_samples(num_time_series=1000, save_to_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts7_raw.csv')
hsl_tsad_agent.nn_train_with = 'tagiv'
hsl_tsad_agent.mean_train, hsl_tsad_agent.std_train, hsl_tsad_agent.mean_target, hsl_tsad_agent.std_target = 3.595366e-05, 0.0012258928, np.array([6.7383415e-05, 6.3103340e-03, 1.0707104e+02]), np.array([1.1198435e-02, 1.3870779e+00, 6.2558418e+01])

hsl_tsad_agent.learn_intervention(training_samples_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts7_raw.csv', 
                                  load_model_path='saved_params/NN_detection_model_real_ts7_raw.pkl', max_training_epoch=50)
