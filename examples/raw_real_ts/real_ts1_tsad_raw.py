...
# hsl_tsad_agent.collect_synthetic_samples(num_time_series=1000, save_to_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts1_raw.csv')
hsl_tsad_agent.nn_train_with = 'tagiv'
hsl_tsad_agent.mean_train, hsl_tsad_agent.std_train, hsl_tsad_agent.mean_target, hsl_tsad_agent.std_target = -3.1046293e-05, 0.0011652658, np.array([-1.52003005e-04, -1.53970709e-02, 1.06991455e+02]), np.array([1.1228583e-02, 1.3905003e+00, 6.2442730e+01])

hsl_tsad_agent.learn_intervention(training_samples_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts1_raw.csv',
                                  load_model_path='saved_params/NN_detection_model_real_ts1_raw.pkl', max_training_epoch=50)
