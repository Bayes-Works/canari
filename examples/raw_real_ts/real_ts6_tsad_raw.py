...
# hsl_tsad_agent.collect_synthetic_samples(num_time_series=1000, save_to_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts6_raw.csv')
hsl_tsad_agent.nn_train_with = 'tagiv'
hsl_tsad_agent.mean_train, hsl_tsad_agent.std_train, hsl_tsad_agent.mean_target, hsl_tsad_agent.std_target = -0.00014156984, 0.0009480181, np.array([2.6881677e-04, 5.1094219e-02, 1.0526788e+02]), np.array([1.0966850e-02, 1.3395894e+00, 6.2521404e+01])

hsl_tsad_agent.learn_intervention(training_samples_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts6_raw.csv', 
                                  load_model_path='saved_params/NN_detection_model_real_ts6_raw.pkl', max_training_epoch=50)
