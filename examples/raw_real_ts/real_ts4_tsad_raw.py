...
# hsl_tsad_agent.collect_synthetic_samples(num_time_series=1000, save_to_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts4_raw.csv')
hsl_tsad_agent.nn_train_with = 'tagiv'
hsl_tsad_agent.mean_train, hsl_tsad_agent.std_train, hsl_tsad_agent.mean_target, hsl_tsad_agent.std_target = 3.7600916e-05, 0.0004128974, np.array([9.39593883e-05, 9.32583865e-03, 1.07196205e+02]), np.array([1.1339025e-02, 1.4094908e+00, 6.2586067e+01])

hsl_tsad_agent.learn_intervention(training_samples_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts4_raw.csv', 
                                  load_model_path='saved_params/NN_detection_model_real_ts4_raw.pkl', max_training_epoch=50)
