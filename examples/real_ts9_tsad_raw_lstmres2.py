...
from src.hsl_detection_new2 import hsl_detection
...
hsl_tsad_agent = hsl_detection(base_model=pretrained_model, generate_model=generate_model, data_processor=data_processor, drift_model_process_error_std=ltd_error, y_std_scale = 10)

# Get flexible drift model from the beginning
hsl_tsad_agent_pre = hsl_detection(base_model=pretrained_model.load_dict(pretrained_model.get_dict()), generate_model=generate_model, data_processor=data_processor, drift_model_process_error_std=ltd_error)
...
# hsl_tsad_agent.collect_synthetic_samples(num_time_series=1000, save_to_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts9_detrended_raw_lstmres2.csv')

# hsl_tsad_agent.mu_LTd = -4.162903781325108e-05
# hsl_tsad_agent.LTd_std = 0.0003183549529823641
# hsl_tsad_agent.LTd_pdf = common.gaussian_pdf(mu = hsl_tsad_agent.mu_LTd, std = hsl_tsad_agent.LTd_std * 1)

hsl_tsad_agent.nn_train_with = 'tagiv'
hsl_tsad_agent.mean_train, hsl_tsad_agent.std_train, hsl_tsad_agent.mean_target, hsl_tsad_agent.std_target = 0.00021325928, 0.0038676064, np.array([-7.2524988e-04, -7.6686658e-02, 1.0735011e+02]), np.array([1.10816695e-02, 1.37814689e+00, 6.26576576e+01])
...
hsl_tsad_agent.learn_intervention(training_samples_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts9_detrended_raw_lstmres2.csv', 
                                  load_model_path='saved_params/NN_detection_model_real_ts9_detrended_raw_lstmres2.pkl', max_training_epoch=50)
