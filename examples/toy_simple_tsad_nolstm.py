...
import pickle
# from src.model import load_dict
...
hsl_tsad_agent_pre = hsl_detection(base_model=Model.load_dict(pretrained_model.get_dict()), data_processor=data_processor, drift_model_process_error_std=ltd_error)
