...
#                                      [0.00012438554254974466, 0.0019682058581424124, 0.019482144531020363],
#                                      [0.00019133634924190676, 2.0009693566699214e-05, 0.033113837294688],
#                                      [0.00016881148477719093, 3.442081808618775e-05, 0.012414744992029407],
#                                      [0.0001463307769031991, 8.494758703807833e-05, 0.016104538338812174],
#                                      [0.0002163264419029818, 7.506295923668678e-05, 0.04614514748837914],
#                                      [0.00028247668836863047, 4.464288184185662e-05, 0.04125869857312016],
#                                      [0.0030632509922986395, 2.767267616830766e-06, 0.1374676830490896],
#                                      [0.0006287170172995989, 1.355548300379989e-06, 0.02025093950026679],
#                                      [0.00023682778829215012, 0.00042743196411294804, 0.11468726578232913],
#                                      [0.00030244245132604223, 0.00021138920271280385, 0.013985465249889112],
#                                      ]

# # Low standard deviation SSM:
# stdtrans_normtoab_probthred_combs = [
#                                      [5.925282833529948e-05, 5.43846067955397e-05, 0.03703203875033275],
#                                      [4.623541005563183e-05, 0.001543711800133425, 0.017863059544232854],
#                                      [0.0002667307470871152, 5.0460051673679e-06, 0.010286669702989677],
#                                      [0.00012877913550247812, 1.4588302772799994e-05, 0.22753205241796357],
#                                      [0.00010102070025931114, 2.3384267481248005e-06, 0.22312606720597086],
#                                      [0.0005424919437036208, 4.1754523295779546e-06, 0.3671149604589262],
#                                      [5.109034048372635e-05, 8.823592381986314e-06, 0.05906941161867593],
#                                      [1.3519517657511189e-05, 0.000636845377190865, 0.01133135694219914],
#                                      [0.00011478011069627704, 0.00011059418737745884, 0.24807156849061235],
#                                      [0.00031543730737761675, 1.7783949481420926e-06, 0.2789659042306188],
#                                      ]

# Retuned - Low standard deviation SSM:
stdtrans_normtoab_probthred_combs = [
                                     [5.925282833529948e-05, 5.43846067955397e-05, 0.03703203875033275],
                                     [4.623541005563183e-05, 0.001543711800133425, 0.117863059544232854],
                                     [0.0002667307470871152, 5.0460051673679e-06, 0.910286669702989677],
                                     [0.00012877913550247812, 1.4588302772799994e-05, 0.22753205241796357],
                                     [0.00010102070025931114, 2.3384267481248005e-06, 0.22312606720597086],
                                     [0.0005424919437036208, 4.1754523295779546e-06, 0.8671149604589262],
                                     [5.109034048372635e-05, 8.823592381986314e-06, 0.05906941161867593],
                                     [1.3519517657511189e-05, 0.000636845377190865, 0.01133135694219914],
                                     [0.00011478011069627704, 0.00011059418737745884, 0.24807156849061235],
                                     [0.00031543730737761675, 1.7783949481420926e-06, 0.8789659042306188],
                                     ]
...
results_df.to_csv("saved_results/prob_eva/detrended_ts7_results_skf_stdlow.csv", index=False)