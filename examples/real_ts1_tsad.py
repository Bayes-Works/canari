...
with open("saved_params/real_ts1_model.pkl", "rb") as f:
...
hsl_tsad_agent.collect_synthetic_samples(num_time_series=1000, anm_type = 'LL + LT', save_to_path= 'data/hsl_tsad_training_samples/itv_learn_samples_real_ts1_V2.csv')
hsl_tsad_agent.nn_train_with = 'tagiv'
hsl_tsad_agent.learn_intervention(training_samples_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts1_V2.csv', 
                                  save_model_path='saved_params/NN_detection_model_realTS1_V2_M1.pkl', max_training_epoch=50)
