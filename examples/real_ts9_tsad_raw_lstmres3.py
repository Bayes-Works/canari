...
from src.hsl_detection_new3 import hsl_detection
...
train_val_data = {"x": normalized_data["x"][0:data_processor.validation_end],
                  "y": normalized_data["y"][0:data_processor.validation_end]}
...
print("phi_AR0 =", model_dict['states_optimal'].mu_prior[-1][phi_index].item())
print("sigma_AR0 =", np.sqrt(model_dict['states_optimal'].mu_prior[-1][W2bar_index].item()))
print("phi_AR1 =", model_dict['gen_sigma_ar'])
print("sigma_AR1 =", model_dict['gen_phi_ar'])
...
# hsl_tsad_agent.mu_LTd = -2.0905287623980633e-05
# hsl_tsad_agent.LTd_std = 0.00014742605424639384
# No roll-out
hsl_tsad_agent.mu_LTd = -0.00013831171609165666
hsl_tsad_agent.LTd_std = 6.135943110558287e-05
# hsl_tsad_agent.tune(data=train_val_data)
hsl_tsad_agent.LTd_pdf = common.gaussian_pdf(mu = hsl_tsad_agent.mu_LTd, std = hsl_tsad_agent.LTd_std * 1)

# hsl_tsad_agent.collect_synthetic_samples(num_time_series=1000, save_to_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts9_detrended_raw_lstmres3.csv')
hsl_tsad_agent.nn_train_with = 'tagiv'
hsl_tsad_agent.mean_train, hsl_tsad_agent.std_train, hsl_tsad_agent.mean_target, hsl_tsad_agent.std_target = 0.00084256957, 0.0016121175, np.array([8.0078263e-03, 8.5918260e-01, 1.0548343e+02]), np.array([9.9638347e-03, 1.3426051e+00, 6.1895298e+01])

hsl_tsad_agent.learn_intervention(training_samples_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts9_detrended_raw_lstmres3.csv', 
                                  load_model_path='saved_params/NN_detection_model_real_ts9_detrended_raw_lstmres3.pkl', max_training_epoch=50)
