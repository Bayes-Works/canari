...
df_il = pd.read_csv("saved_results/prob_eva/detrended_ts6_results_il.csv")
...
df_skf = pd.read_csv("saved_results/prob_eva/detrended_ts6_results_skf.csv")
...
# df_skf_whitenoise = pd.read_csv("saved_results/prob_eva/detrended_ts4_whitenoise_skf.csv")
...
df_prophet = pd.read_csv("saved_results/prob_eva/detrended_ts6_results_prophet_online.csv")
