...
# df_il = pd.read_csv("saved_results/prob_eva/detrended_ts9_results_il.csv")
df_il = pd.read_csv("saved_results/prob_eva/detrended_ts9_wn_results_il.csv")
df_skf = pd.read_csv("saved_results/prob_eva/detrended_ts9_results_skf.csv")
df_mp = pd.read_csv("saved_results/prob_eva/detrended_ts9_results_mp.csv")
df_prophet = pd.read_csv("saved_results/prob_eva/detrended_ts9_results_prophet_online.csv")
