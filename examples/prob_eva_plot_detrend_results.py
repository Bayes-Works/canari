...
df_il = pd.read_csv("saved_results/prob_eva/detrended_ts3_results_il.csv")
...
df_skf = pd.read_csv("saved_results/prob_eva/detrended_ts3_results_skf.csv")
...
# df_skf_whitenoise = pd.read_csv("saved_results/prob_eva/detrended_ts7_whitenoise_skf.csv")

# df_prophet = pd.read_csv("saved_results/prob_eva/detrended_ts1_results_prophet_online.csv")
# df_prophet = pd.read_csv("saved_results/prob_eva/detrended_ts5_results_prophet_online.csv")
df_prophet = pd.read_csv("saved_results/prob_eva/detrended_ts3_results_prophet_online.csv")
...
#     color = "tab:green"
# )
ax[4].plot(df_prophet_mean.index, df_prophet_mean["false_alarms_num"]["mean"], label="Prophet", color = "tab:red")
ax[4].fill_between(
    df_prophet_mean.index,
