...
stdtrans_normtoab_probthred_combs = [
                                     [3.82100718171035e-05, 0.005291795615981632, 0.08714514061381301],
                                     [0.00028599643351240247, 1.9435309375440897e-05, 0.08690186727256359],
                                     [0.00039591951092504934, 4.8118481023584834e-06, 0.021517455854797182],
                                     [0.00015763281995544447, 0.0006115859891396914, 0.024402564798900947],
                                     [0.000396683927865538, 4.5417894051215916e-05, 0.027020034235125927],
                                     [0.0007449956956960232, 1.0786065599811768e-06, 0.08659609520907431],
                                     [0.0006042758968802989, 6.8042773855808e-05, 0.045841758412783505],
                                     [2.1000416695983524e-05, 0.0004320239874051162, 0.06640316400900514],
                                     [0.0001728743572423199, 7.246257257370129e-05, 0.0795339543769546],
                                     [0.00023700507652850894, 0.0003044366428557823, 0.011775495968657027],
                                     ]
...
# # # Read test data
df = pd.read_csv("data/prob_eva_syn_time_series/detrended_ts3_tsgen.csv")
...
results_df.to_csv("saved_results/prob_eva/detrended_ts3_results_skf.csv", index=False)