...
hsl_tsad_agent.mu_LTd = -4.476798338746532e-05
hsl_tsad_agent.LTd_pdf = common.gaussian_pdf(mu = hsl_tsad_agent.mu_LTd, std = 2.48676551325589e-05)
...
# hsl_tsad_agent.collect_synthetic_samples(num_time_series=1000, anm_type = 'LL + LT', save_to_path= 'data/hsl_tsad_training_samples/itv_learn_samples_real_ts4_V2.csv')
hsl_tsad_agent.nn_train_with = 'tagiv'
hsl_tsad_agent.learn_intervention(training_samples_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts4_V2.csv', 
                                  load_model_path='saved_params/NN_detection_model_realTS4_lstm_V2_M1.pkl', max_training_epoch=50)
