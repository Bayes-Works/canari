...
hsl_tsad_agent.mu_LTd = 6.277331895212248e-06
hsl_tsad_agent.LTd_std = 3.625988058355313e-05
hsl_tsad_agent.LTd_pdf = common.gaussian_pdf(mu = hsl_tsad_agent.mu_LTd, std = hsl_tsad_agent.LTd_std * 1)

# hsl_tsad_agent.collect_synthetic_samples(num_time_series=1000, save_to_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts4_detrended.csv')
hsl_tsad_agent.nn_train_with = 'tagiv'
hsl_tsad_agent.mean_train, hsl_tsad_agent.std_train, hsl_tsad_agent.mean_target, hsl_tsad_agent.std_target = 5.605084e-05, 0.0015063697, np.array([8.5702486e-05, 1.8800478e-02, 1.0551485e+02]), np.array([1.0925847e-02, 1.3081175e+00, 6.2117470e+01])
# hsl_tsad_agent.tune(decay_factor=0.95)
hsl_tsad_agent.LTd_pdf = common.gaussian_pdf(mu = hsl_tsad_agent.mu_LTd, std = hsl_tsad_agent.LTd_std * 3.9)
hsl_tsad_agent.learn_intervention(training_samples_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts4_detrended.csv', 
                                  load_model_path='saved_params/NN_detection_model_real_ts4_detrended.pkl', max_training_epoch=50)
