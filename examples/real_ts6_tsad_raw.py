...
hsl_tsad_agent.mu_LTd = -2.2093526995556843e-05
hsl_tsad_agent.LTd_std = 8.624563103255851e-05
hsl_tsad_agent.LTd_pdf = common.gaussian_pdf(mu = hsl_tsad_agent.mu_LTd, std = hsl_tsad_agent.LTd_std * 1)

# hsl_tsad_agent.collect_synthetic_samples(num_time_series=1000, save_to_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts6_detrended_raw.csv')
hsl_tsad_agent.nn_train_with = 'tagiv'
hsl_tsad_agent.mean_train, hsl_tsad_agent.std_train, hsl_tsad_agent.mean_target, hsl_tsad_agent.std_target = -4.1014446e-05, 0.00096605683, np.array([4.4597280e-05, 1.0727119e-02, 1.0688127e+02]), np.array([1.1024388e-02, 1.3614551e+00, 6.2485394e+01])
# hsl_tsad_agent.tune()
# hsl_tsad_agent.LTd_pdf = common.gaussian_pdf(mu = hsl_tsad_agent.mu_LTd, std = hsl_tsad_agent.LTd_std * 0.7290000000000001)
hsl_tsad_agent.learn_intervention(training_samples_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts6_detrended_raw.csv', 
                                  load_model_path='saved_params/NN_detection_model_real_ts6_detrended_raw.pkl', max_training_epoch=50)
