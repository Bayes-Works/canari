...
with open("saved_params/real_ts8_tsmodel_raw.pkl", "rb") as f:
...
hsl_tsad_agent.mu_LTd = -1.5866536766540417e-06
hsl_tsad_agent.LTd_std = 4.947561069148697e-05
hsl_tsad_agent.LTd_pdf = common.gaussian_pdf(mu = hsl_tsad_agent.mu_LTd, std = hsl_tsad_agent.LTd_std * 1)

# hsl_tsad_agent.collect_synthetic_samples(num_time_series=1000, save_to_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts8_detrended_raw.csv')
hsl_tsad_agent.nn_train_with = 'tagiv'
hsl_tsad_agent.mean_train, hsl_tsad_agent.std_train, hsl_tsad_agent.mean_target, hsl_tsad_agent.std_target = -3.3197648e-05, 0.0012702652, np.array([3.60842154e-04, 7.87374452e-02, 1.03759735e+02]), np.array([1.0681967e-02, 1.2461331e+00, 6.1926052e+01])
# hsl_tsad_agent.tune()
# hsl_tsad_agent.LTd_pdf = common.gaussian_pdf(mu = hsl_tsad_agent.mu_LTd, std = hsl_tsad_agent.LTd_std * 0.7290000000000001)
hsl_tsad_agent.learn_intervention(training_samples_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts8_detrended_raw.csv', 
                                  load_model_path='saved_params/NN_detection_model_real_ts8_detrended_raw.pkl', max_training_epoch=50)
