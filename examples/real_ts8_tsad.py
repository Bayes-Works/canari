...
with open("saved_params/real_ts8_model.pkl", "rb") as f:
...
# # V2
# hsl_tsad_agent.mu_LTd = 4.2625015056054164e-07
# hsl_tsad_agent.LTd_pdf = common.gaussian_pdf(mu = hsl_tsad_agent.mu_LTd, std = 1.7051884197685264e-05)
# # V3
hsl_tsad_agent.mu_LTd = 9.360372736423289e-07
hsl_tsad_agent.LTd_pdf = common.gaussian_pdf(mu = hsl_tsad_agent.mu_LTd, std = 1.4790893223438552e-05)

# hsl_tsad_agent.collect_synthetic_samples(num_time_series=1000, anm_type = 'LL + LT', save_to_path= 'data/hsl_tsad_training_samples/itv_learn_samples_real_ts8_V3.csv')
hsl_tsad_agent.nn_train_with = 'tagiv'
hsl_tsad_agent.learn_intervention(training_samples_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts8_V3.csv', 
                                  load_model_path='saved_params/NN_detection_model_realTS8_lstm_V3_M2.pkl', max_training_epoch=50)
