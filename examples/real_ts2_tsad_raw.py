...
hsl_tsad_agent.mu_LTd = 4.3841220010960204e-05
hsl_tsad_agent.LTd_std = 4.701485388606569e-05
hsl_tsad_agent.LTd_pdf = common.gaussian_pdf(mu = hsl_tsad_agent.mu_LTd, std = hsl_tsad_agent.LTd_std * 1)

# hsl_tsad_agent.collect_synthetic_samples(num_time_series=1000, save_to_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts2_detrended_raw.csv')
hsl_tsad_agent.nn_train_with = 'tagiv'
hsl_tsad_agent.mean_train, hsl_tsad_agent.std_train, hsl_tsad_agent.mean_target, hsl_tsad_agent.std_target = 1.3114315e-05, 0.000816104, np.array([7.9789097e-05, 6.7030196e-03, 1.0751213e+02]), np.array([1.1430159e-02, 1.4220637e+00, 6.2622738e+01])
# hsl_tsad_agent.tune()
# hsl_tsad_agent.LTd_pdf = common.gaussian_pdf(mu = hsl_tsad_agent.mu_LTd, std = hsl_tsad_agent.LTd_std * 0.7290000000000001)
hsl_tsad_agent.learn_intervention(training_samples_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts2_detrended_raw.csv', 
                                  load_model_path='saved_params/NN_detection_model_real_ts2_detrended_raw.pkl', max_training_epoch=50)
