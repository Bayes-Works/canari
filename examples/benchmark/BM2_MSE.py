...
def main(
    ...
    def model_with_parameters(param, train_data, validation_data):
        ...
        mse = metric.mse(mu_preds_unnorm, obs_all)

        # skf.metric_optim = -log_lik_all
        skf.metric_optim = mse
    ...
    if param_optimization:
        ...
        with open("saved_params/benchmark_2_MSE.pkl", "wb") as f:
            pickle.dump(skf_optim_dict, f)
    else:
        with open("saved_params/benchmark_2_MSE.pkl", "rb") as f:
    ...
    plt.savefig("./saved_results/BM2_MSE.png")
    plt.show()
