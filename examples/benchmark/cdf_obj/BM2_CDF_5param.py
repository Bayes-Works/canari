...
def main(
    ...
    if param_optimization:
        ...
        skf_optim, _ = model_with_parameters(param, train_data, validation_data)

        skf_optim_dict = skf_optim.get_dict()
        skf_optim_dict["model_param"] = param
        skf_optim_dict["cov_names"] = train_data["cov_names"]
        with open("saved_params/cdf_obj/BM2_CDF_5param_1.pkl", "wb") as f:
            pickle.dump(skf_optim_dict, f)
    else:
        with open("saved_params/cdf_obj/BM2_CDF_5param_1.pkl", "rb") as f:
    ...
    plt.savefig("./saved_results/cdf_obj/BM2_CDF_5param_1.png")
    plt.show()
