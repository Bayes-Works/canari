...
def main(
    ...
    if param_optimization:
        ...
        with open("saved_params/cdf_obj/BM9_CDF_5param_1.pkl", "wb") as f:
            pickle.dump(skf_optim_dict, f)
    else:
        with open("saved_params/cdf_obj/BM9_CDF_5param_1.pkl", "rb") as f:
    ...
    plt.savefig("./saved_results/cdf_obj/BM9_CDF_5param_1.png")
    plt.show()
