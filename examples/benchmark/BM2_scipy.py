...
def main(
    ...
    def skf_with_parameters(skf_param_space, model_param: dict, train_data):
        ...
        skf.metric_optim["anomaly_magnitude"] = slope

        return skf

    # ---------- logging wrapper (Option 1) ----------
    eval_history = []  # list of tuples: (linear_params, objective_value)
    ...
    print(f"Optimal (linear): {params_str}")
