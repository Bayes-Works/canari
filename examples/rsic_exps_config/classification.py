...
FNN = Sequential(
    Linear(784, 128, gain_weight=0.2, gain_bias=0.2),
    ReLU(),
    Linear(128, 128, gain_weight=0.2, gain_bias=0.2),
    ReLU(),
    Linear(128, 10, gain_weight=0.2, gain_bias=0.2),
...
def main(num_epochs: int = 20, batch_size: int = 128, sigma_v: float = 0.01):
    """
