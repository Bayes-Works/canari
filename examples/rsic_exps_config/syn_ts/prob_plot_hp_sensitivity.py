...
ax[0].plot(df_hp1_group.index, df_hp1_group["detection_time"]["mean"], label=r"$p=0.1\%$")
ax[0].fill_between(
    df_hp1_group.index,
...
ax[0].plot(df_hp2_group.index, df_hp2_group["detection_time"]["mean"], label=r"$p=0.5\%$$")
ax[0].fill_between(
    df_hp2_group.index,
...
ax[0].plot(df_hp3_group.index, df_hp3_group["detection_time"]["mean"], label=r"$p=1\%$$")
ax[0].fill_between(
    df_hp3_group.index,
...
ax[0].plot(df_hp4_group.index, df_hp4_group["detection_time"]["mean"], label=r"$p=5\%$$")
ax[0].fill_between(
    df_hp4_group.index,
...
# fig, ax = plt.subplots(3, 1, figsize=(3, 3.5), constrained_layout=True)

# # Plot for intervention_time
# ax[0].plot(df_hp1_group.index, df_hp1_group["intervention_time"]["mean"], label=r"$p=0.001$")
# ax[0].fill_between(
#     df_hp1_group.index,
#     df_hp1_group["intervention_time"]["mean"] - df_hp1_group["intervention_time"]["std"],
#     df_hp1_group["intervention_time"]["mean"] + df_hp1_group["intervention_time"]["std"],
#     alpha=0.2,
# )
# ax[0].plot(df_hp2_group.index, df_hp2_group["intervention_time"]["mean"], label=r"$p=0.005$")
# ax[0].fill_between(
#     df_hp2_group.index,
#     df_hp2_group["intervention_time"]["mean"] - df_hp2_group["intervention_time"]["std"],
#     df_hp2_group["intervention_time"]["mean"] + df_hp2_group["intervention_time"]["std"],
#     alpha=0.2,
# )
# ax[0].plot(df_hp3_group.index, df_hp3_group["intervention_time"]["mean"], label=r"$p=0.01$")
# ax[0].fill_between(
#     df_hp3_group.index,
#     df_hp3_group["intervention_time"]["mean"] - df_hp3_group["intervention_time"]["std"],
#     df_hp3_group["intervention_time"]["mean"] + df_hp3_group["intervention_time"]["std"],
#     alpha=0.2,
# )
# ax[0].plot(df_hp4_group.index, df_hp4_group["intervention_time"]["mean"], label=r"$p=0.05$")
# ax[0].fill_between(
#     df_hp4_group.index,
#     df_hp4_group["intervention_time"]["mean"] - df_hp4_group["intervention_time"]["std"],
#     df_hp4_group["intervention_time"]["mean"] + df_hp4_group["intervention_time"]["std"],
#     alpha=0.2,
# )
# ax[0].set_ylabel(r"$\Delta_t^{\mathtt{ITV}}(\mathrm{y})$")
# ax[0].set_yticks([0, 52, 104, 156])
# ax[0].set_yticklabels([0, 1, 2, 3])
# ax[0].set_xscale('log')
# # ax[0].set_ylim(0, 52 * 3.05)
...
# # Plot for detection_time
# # ax[1].plot(df_hp1_group.index, df_hp1_group["detection_time"]["mean"], label=r"$\hat{t}=1\mathrm{yr}$")
# ax[1].plot(df_hp1_group.index, df_hp1_group["detection_time"]["mean"], label=r"$p=0.001$")
# ax[1].fill_between(
#     df_hp1_group.index,
#     df_hp1_group["detection_time"]["mean"] - df_hp1_group["detection_time"]["std"],
#     df_hp1_group["detection_time"]["mean"] + df_hp1_group["detection_time"]["std"],
#     alpha=0.2,
# )
# # ax[1].plot(df_hp2_group.index, df_hp2_group["detection_time"]["mean"], label=r"$\hat{t}=3\mathrm{yrs}$")
# ax[1].plot(df_hp2_group.index, df_hp2_group["detection_time"]["mean"], label=r"$p=0.005$")
# ax[1].fill_between(
#     df_hp2_group.index,
#     df_hp2_group["detection_time"]["mean"] - df_hp2_group["detection_time"]["std"],
#     df_hp2_group["detection_time"]["mean"] + df_hp2_group["detection_time"]["std"],
#     alpha=0.2,
# )
# # ax[1].plot(df_hp3_group.index, df_hp3_group["detection_time"]["mean"], label=r"$\hat{t}=5\mathrm{yrs}$")
# ax[1].plot(df_hp3_group.index, df_hp3_group["detection_time"]["mean"], label=r"$p=0.01$")
# ax[1].fill_between(
#     df_hp3_group.index,
#     df_hp3_group["detection_time"]["mean"] - df_hp3_group["detection_time"]["std"],
#     df_hp3_group["detection_time"]["mean"] + df_hp3_group["detection_time"]["std"],
#     alpha=0.2,
# )
# # ax[1].plot(df_hp4_group.index, df_hp4_group["detection_time"]["mean"], label=r"$\hat{t}=7\mathrm{yrs}$")
# ax[1].plot(df_hp4_group.index, df_hp4_group["detection_time"]["mean"], label=r"$p=0.05$")
# ax[1].fill_between(
#     df_hp4_group.index,
#     df_hp4_group["detection_time"]["mean"] - df_hp4_group["detection_time"]["std"],
#     df_hp4_group["detection_time"]["mean"] + df_hp4_group["detection_time"]["std"],
#     alpha=0.2,
# )
# ax[1].set_ylabel(r"$\Delta_t(\mathrm{y})$")
# ax[1].set_yticks([0, 52, 104, 156])
# ax[1].set_yticklabels([0, 1, 2, 3])
# ax[1].set_xscale('log')
# ax[1].set_ylim(0, 52 * 3.05)
# ax[1].set_xticklabels([])

# # Plot for detection_rate
# # ax[2].plot(df_hp1_group.index, df_hp1_group["detection_rate"]["mean"], label=r"$\hat{t}=1\mathrm{yr}$")
# # ax[2].plot(df_hp2_group.index, df_hp2_group["detection_rate"]["mean"], label=r"$\hat{t}=3\mathrm{yrs}$")
# # ax[2].plot(df_hp3_group.index, df_hp3_group["detection_rate"]["mean"], label=r"$\hat{t}=5\mathrm{yrs}$")
# # ax[2].plot(df_hp4_group.index, df_hp4_group["detection_rate"]["mean"], label=r"$\hat{t}=7\mathrm{yrs}$")
# ax[2].plot(df_hp1_group.index, df_hp1_group["detection_rate"]["mean"], label=r"$p=0.001$")
# ax[2].plot(df_hp2_group.index, df_hp2_group["detection_rate"]["mean"], label=r"$p=0.005$")
# ax[2].plot(df_hp3_group.index, df_hp3_group["detection_rate"]["mean"], label=r"$p=0.01$")
# ax[2].plot(df_hp4_group.index, df_hp4_group["detection_rate"]["mean"], label=r"$p=0.05$")
# ax[2].set_ylabel(r"$\mathcal{P}_{\mathtt{DET}}$")
