...
df = pd.read_csv("data/prob_eva_syn_time_series/detrend_rsic_simple_ts9_gen_lttoll.csv")
...
hsl_tsad_agent.LTd_std = 5.0103186390208604e-05 * 3
...
hsl_tsad_agent.detection_threshold = 0.15619172975641848

hsl_tsad_agent.mean_LTd_class, hsl_tsad_agent.std_LTd_class = 6.847989e-05, 0.00027106208
hsl_tsad_agent.mean_target_lt_model, hsl_tsad_agent.std_target_lt_model = np.array([1.2804653e-06, -5.6584985e-03]), np.array([0.00655846, 0.87692076])
hsl_tsad_agent.mean_target_ll_model, hsl_tsad_agent.std_target_ll_model = np.array([0.01692993]), np.array([0.67772615])

hsl_tsad_agent.learn_intervention(training_samples_path='data/anm_type_class_train_samples/classifier_learn_samples_detrended_ts9.csv', 
                                    load_lt_model_path='saved_params/NN_intervention_LT_model_rsic_detrend_ts9.pkl', 
                                    load_ll_model_path='saved_params/NN_intervention_LL_model_rsic_detrend_ts9.pkl', 
...
results_df.to_csv("saved_results/prob_eva/detrend_ts9_results_rsic_lttoll.csv", index=False)