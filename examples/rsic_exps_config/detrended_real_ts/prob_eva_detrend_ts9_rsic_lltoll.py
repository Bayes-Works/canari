...
df = pd.read_csv("data/prob_eva_syn_time_series/detrend_rsic_simple_ts9_gen_lltoll.csv")
...
results_df.to_csv("saved_results/prob_eva/detrend_ts9_results_rsic_lltoll.csv", index=False)