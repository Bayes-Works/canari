...
df = pd.read_csv("data/prob_eva_syn_time_series/detrend_rsic_simple_ts10_gen_lttolt.csv")
...
hsl_tsad_agent.mean_LTd_class, hsl_tsad_agent.std_LTd_class = 3.369846e-05, 0.00062698044
hsl_tsad_agent.mean_target_lt_model, hsl_tsad_agent.std_target_lt_model = np.array([0.00010886, 0.01388391]), np.array([0.00647311, 0.8629422])
hsl_tsad_agent.mean_target_ll_model, hsl_tsad_agent.std_target_ll_model = np.array([0.00331967]), np.array([0.6672001])

hsl_tsad_agent.learn_intervention(training_samples_path='data/anm_type_class_train_samples/classifier_learn_samples_detrended_ts10.csv', 
                                    load_lt_model_path='saved_params/NN_intervention_LT_model_rsic_detrend_ts10.pkl', 
                                    load_ll_model_path='saved_params/NN_intervention_LL_model_rsic_detrend_ts10.pkl', 
...
results_df.to_csv("saved_results/prob_eva/detrend_ts10_results_rsic_lttolt.csv", index=False)