...
df = pd.read_csv("data/prob_eva_syn_time_series/detrend_rsic_simple_ts8_gen_lttolt.csv")
...
results_df.to_csv("saved_results/prob_eva/detrend_ts8_results_rsic_lttolt.csv", index=False)