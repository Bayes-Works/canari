...
hsl_tsad_agent.mean_train, hsl_tsad_agent.std_train, hsl_tsad_agent.mean_target, hsl_tsad_agent.std_target = 3.85333e-05, 0.0002956695, np.array([-2.06807768e-03, -3.44924688e-01, 1.03883316e+02]), np.array([1.0522538e-02, 1.2020638e+00, 6.7070213e+01])
hsl_tsad_agent.learn_intervention(training_samples_path='data/hsl_tsad_training_samples/rsi_learn_samples_detrended_ts9.csv', 
                                  load_model_path='saved_params/NN_intervention_model_detrended_ts9_rsi.pkl', max_training_epoch=50)
...
results_df.to_csv("saved_results/prob_eva/detrend_ts9_results_rsi_lttolt.csv", index=False)