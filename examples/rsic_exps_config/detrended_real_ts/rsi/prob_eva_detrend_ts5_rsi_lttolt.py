...
hsl_tsad_agent.mean_train, hsl_tsad_agent.std_train, hsl_tsad_agent.mean_target, hsl_tsad_agent.std_target = -0.00010275731, 0.0021063741, np.array([-4.8192084e-04, -6.3140027e-02, 1.1199992e+02]), np.array([1.1012262e-02, 1.4403012e+00, 6.8237755e+01])
hsl_tsad_agent.learn_intervention(training_samples_path='data/hsl_tsad_training_samples/rsi_learn_samples_detrended_ts5.csv', 
                                  load_model_path='saved_params/NN_intervention_model_detrended_ts5_rsi.pkl', max_training_epoch=50)
...
results_df.to_csv("saved_results/prob_eva/detrend_ts5_results_rsi_lttolt.csv", index=False)