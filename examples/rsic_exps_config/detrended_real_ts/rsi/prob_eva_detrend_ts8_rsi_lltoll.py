...
hsl_tsad_agent.mean_train, hsl_tsad_agent.std_train, hsl_tsad_agent.mean_target, hsl_tsad_agent.std_target = -0.00011642441, 0.0011420525, np.array([-3.0787670e-04, -3.9767448e-02, 1.1337966e+02]), np.array([1.1152801e-02, 1.4799588e+00, 6.9244972e+01])
hsl_tsad_agent.learn_intervention(training_samples_path='data/hsl_tsad_training_samples/rsi_learn_samples_detrended_ts8.csv', 
                                  load_model_path='saved_params/NN_intervention_model_detrended_ts8_rsi.pkl', max_training_epoch=50)
...
results_df.to_csv("saved_results/prob_eva/detrend_ts8_results_rsi_lltoll.csv", index=False)