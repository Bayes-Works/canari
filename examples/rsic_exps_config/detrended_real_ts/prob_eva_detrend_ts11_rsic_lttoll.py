...
hsl_tsad_agent.mean_LTd_class, hsl_tsad_agent.std_LTd_class = 4.573277e-06, 0.0007423348
hsl_tsad_agent.mean_target_lt_model, hsl_tsad_agent.std_target_lt_model = np.array([-0.00027113, -0.02635074]), np.array([0.00681782, 0.90232426])
hsl_tsad_agent.mean_target_ll_model, hsl_tsad_agent.std_target_ll_model = np.array([0.03636666]), np.array([0.6859797])

hsl_tsad_agent.learn_intervention(training_samples_path='data/anm_type_class_train_samples/classifier_learn_samples_detrended_ts11.csv', 
                                    load_lt_model_path='saved_params/NN_intervention_LT_model_rsic_detrend_ts11.pkl', 
                                    load_ll_model_path='saved_params/NN_intervention_LL_model_rsic_detrend_ts11.pkl', 
...
results_df.to_csv("saved_results/prob_eva/detrend_ts11_results_rsic_lttoll.csv", index=False)