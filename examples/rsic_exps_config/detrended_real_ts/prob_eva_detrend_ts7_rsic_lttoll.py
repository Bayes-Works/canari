...
df = pd.read_csv("data/prob_eva_syn_time_series/detrend_rsic_simple_ts7_gen_lttoll.csv")
...
hsl_tsad_agent.mu_LTd = -3.0664717756077666e-05
hsl_tsad_agent.LTd_std = 9.015917068305184e-05
...
hsl_tsad_agent.detection_threshold = 0.14037211843296307

hsl_tsad_agent.mean_LTd_class, hsl_tsad_agent.std_LTd_class = -7.6126666e-06, 0.001440193
hsl_tsad_agent.mean_target_lt_model, hsl_tsad_agent.std_target_lt_model = np.array([3.817485e-05, 9.628703e-03]), np.array([0.00689293, 0.92863846])
hsl_tsad_agent.mean_target_ll_model, hsl_tsad_agent.std_target_ll_model = np.array([-0.01647316]), np.array([0.65998733])

hsl_tsad_agent.learn_intervention(training_samples_path='data/anm_type_class_train_samples/classifier_learn_samples_detrended_ts7.csv', 
                                    load_lt_model_path='saved_params/NN_intervention_LT_model_rsic_detrend_ts7.pkl', 
                                    load_ll_model_path='saved_params/NN_intervention_LL_model_rsic_detrend_ts7.pkl', 
...
results_df.to_csv("saved_results/prob_eva/detrend_ts7_results_rsic_lttoll.csv", index=False)