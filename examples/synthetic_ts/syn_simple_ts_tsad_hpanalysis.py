...
# hsl_tsad_agent.collect_synthetic_samples(num_time_series=1000, save_to_path='data/hsl_tsad_training_samples/itv_learn_samples_syn_simple_ts_history256.csv')
...
hsl_tsad_agent.learn_intervention(training_samples_path='data/hsl_tsad_training_samples/itv_learn_samples_syn_simple_ts.csv', 
                                  save_model_path='saved_params/NN_detection_model_syn_simple_ts_layer2_256.pkl', max_training_epoch=50)
