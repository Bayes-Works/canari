...
def main(
    ...
    with open('saved_params/syn_complex_ts_models/skf_param10.pkl', 'wb') as f:
        pickle.dump(skf_param, f)

    with open('saved_params/syn_complex_ts_models/model_optim_dict10.pkl', 'wb') as f:
