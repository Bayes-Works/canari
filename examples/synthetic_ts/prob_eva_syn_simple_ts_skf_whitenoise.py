...
for k in range(1, 1+num_models):
    ...
    with open(f"saved_params/syn_simple_ts_models/skf_param{k}.pkl", "rb") as f:
        skf_param = pickle.load(f)
    with open(f"saved_params/syn_simple_ts_models/model_optim_dict{k}.pkl", "rb") as f:
    ...
    with open(f"saved_params/syn_simple_ts_models/skf_param_retuned{k}.pkl", "wb") as f:
...
#     k += 120
    ...
    with open(f"saved_params/syn_simple_ts_models/skf_param_retuned{model_index}.pkl", "rb") as f:
        skf_param = pickle.load(f)
    with open(f"saved_params/syn_simple_ts_models/model_optim_dict{model_index}.pkl", "rb") as f:
        model_optim_dict = pickle.load(f)
...
results_df.to_csv("saved_results/prob_eva/syn_simple_ts_whitenoise_skf.csv", index=False)
