...
df_raw = pd.read_csv(
    "/Users/michelwu/Desktop/Exp DAT/2650F162.DAT",
...
exponential = Exponential(
    mu_states=[0, 0.01, 22, 0, 0],
    var_states=[0.00001**2, 0.0075**2, 0.5**2, 0, 0],
)
...
periodic = Periodic(mu_states=[1, 1], var_states=[0.5**2, 0.5**2], period=12)
var_W2bar_prior = 5
AR_process_error_var_prior = 5
ar = Autoregression(
    phi=0,
