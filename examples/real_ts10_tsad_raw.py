...
hsl_tsad_agent.mu_LTd = 6.910114763389513e-07
hsl_tsad_agent.LTd_std = 5.34727553041362e-05
hsl_tsad_agent.LTd_pdf = common.gaussian_pdf(mu = hsl_tsad_agent.mu_LTd, std = hsl_tsad_agent.LTd_std * 1)

# hsl_tsad_agent.collect_synthetic_samples(num_time_series=1000, save_to_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts10_detrended_raw.csv')
hsl_tsad_agent.nn_train_with = 'tagiv'
hsl_tsad_agent.mean_train, hsl_tsad_agent.std_train, hsl_tsad_agent.mean_target, hsl_tsad_agent.std_target = -2.3526876e-05, 0.0012369981, np.array([2.9615630e-04, 6.8532154e-02, 1.0425363e+02]), np.array([1.0724423e-02, 1.2675376e+00, 6.2038284e+01])
# hsl_tsad_agent.tune()
# hsl_tsad_agent.LTd_pdf = common.gaussian_pdf(mu = hsl_tsad_agent.mu_LTd, std = hsl_tsad_agent.LTd_std * 0.7290000000000001)
hsl_tsad_agent.learn_intervention(training_samples_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts10_detrended_raw.csv', 
                                  load_model_path='saved_params/NN_detection_model_real_ts10_detrended_raw.pkl', max_training_epoch=50)
