...
# # Read data
data_file = "./data/real_time_series/test_8_data.csv"
...
sigma_v = 0.0178919637745888

model = Model(
    # LocalTrend(mu_states=[-0.08309378, 0.00077297]),
    # LocalTrend(mu_states=[0.47654143, 0.0613781], var_states=[1e-2, 1e-2]),
    LocalTrend(),
    LstmNetwork(
        look_back_len=22,
        num_features=5,
...
model.auto_initialize_baseline_states(train_data["y"][20:72+52+52])
# model.auto_initialize_baseline_states(train_data["y"][20:72])
