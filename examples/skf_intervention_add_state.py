...
from canari.component import LocalTrend, LocalAcceleration, LstmNetwork, WhiteNoise, Intervention
...
intervention = Intervention(interv_state_index=0)
...
# # Anomaly Detection
filter_marginal_abnorm_prob, states = skf.filter(data=all_data, intervention=intervention)
