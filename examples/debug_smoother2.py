...
from canari.component import Exponential, ExpSimp, WhiteNoise, Periodic, LocalTrend
...
df_raw = pd.read_csv(
    ...
    "/Users/michelwu/Desktop/Exponential component/donnees_synthetiquesscaledexp.csv",
...
exponential = Exponential(
    mu_states=[0, 0.09, 4.5, 0, 0],
    var_states=[1e-8**2, 0.02**2, 0.5**2, 0, 0],
)
