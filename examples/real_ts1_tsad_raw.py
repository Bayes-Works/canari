...
# hsl_tsad_agent.mu_LTd = -1.3048430044189837e-05
# hsl_tsad_agent.LTd_std = 4.3723328208325e-05
hsl_tsad_agent.LTd_pdf = common.gaussian_pdf(mu = hsl_tsad_agent.mu_LTd, std = hsl_tsad_agent.LTd_std * 1)

# hsl_tsad_agent.collect_synthetic_samples(num_time_series=1000, save_to_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts1_detrended_raw.csv')
hsl_tsad_agent.nn_train_with = 'tagiv'
hsl_tsad_agent.mean_train, hsl_tsad_agent.std_train, hsl_tsad_agent.mean_target, hsl_tsad_agent.std_target = 2.0806523e-05, 0.0002520597, np.array([8.5998862e-04, 9.4906099e-02, 1.0767964e+02]), np.array([1.1278552e-02, 1.4072430e+00, 6.2800930e+01])
# hsl_tsad_agent.tune(begin_std_LTd = 3)
# hsl_tsad_agent.LTd_pdf = common.gaussian_pdf(mu = hsl_tsad_agent.mu_LTd, std = hsl_tsad_agent.LTd_std * 1.9683000000000004)
hsl_tsad_agent.LTd_pdf = common.gaussian_pdf(mu = hsl_tsad_agent.mu_LTd, std = hsl_tsad_agent.LTd_std * 1)
hsl_tsad_agent.learn_intervention(training_samples_path='data/hsl_tsad_training_samples/itv_learn_samples_real_ts1_detrended_raw.csv', 
                                  load_model_path='saved_params/NN_detection_model_real_ts1_detrended_raw.pkl', max_training_epoch=50)
